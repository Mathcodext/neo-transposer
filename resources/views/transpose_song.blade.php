...
@section('content')
    ...
    @if ($song->song->url)
        <h3 class="song-url">
            <a href="{{ $song->song->url }}" target="_blank" rel="noopener" class="song-url-link">
                <img src="{{ url('/static/img/site-ressucite-fr.png') }}" alt="Ressuscité - Chants pour les communautés néocatéchuménales" class="song-url-img" />
                <span class="song-url-text">
